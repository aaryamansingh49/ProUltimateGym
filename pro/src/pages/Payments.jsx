...
export default function PaymentsSection() {
  ...
  <div className="min-h-screen flex bg-gray-900 text-gray-100">
    ...
    <main className="flex-1 p-6">
      ...
      {/* ===== ORIGINAL CONTENT ===== */}
      <div className="bg-[#0d0d0d] text-gray-100 p-6 min-h-screen">
              ...
              return (
                ...
                >
                  ...
                  <div className="space-y-2 text-md">
                    <p><span className="text-gray-400">Base Amount:</span> <span className="font-semibold text-white">₹{base}</span></p>
                    <p><span className="text-gray-400">Renewal Revenue:</span> <span className="font-semibold text-white">₹{renew}</span></p>
                    <p><span className="text-gray-400">Total Collected:</span> <span className="font-semibold text-green-400">₹{totalCollected}</span></p>
                    <p><span className="text-gray-400">Renewals:</span> {renewCount}</p>
                    <p><span className="text-gray-400">Payment ID:</span> {p.paymentId || "N/A"}</p>
                    <p><span className="text-gray-400">Start Date:</span> {p.startDate}</p>
                  </div>
